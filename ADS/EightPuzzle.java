 ...
 * 
 * 
 * AI solution to N-by-N slider puzzle using heuristic function which is depth in tree plus number of tiles out of position.
 * 
 * Note: integer 0 corresponds to blank cell
 * 
 * Goal state is of the following form and is hard wired into the dist() and manhattan() methods.
 * 
 * 1 2 3 4 5 6 7 8
 * 
 *************************************************************************/
