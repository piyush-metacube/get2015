...
public class TruthTableGenerator {
	...
	for (int i = 0; i < inputLength; i++) {
	    ...
	    /*
	     * if the character is ')' then pop elements from stack and add them to postfix String until '(' is encountered and then also pop the top element i.e.'('
	     */
	    else if (temp == ')') {
		if (countBraces == 0) {
	...
	/*
	 * After complete traversal of input expression, all the elements of stack are added to postfix string
	 */
