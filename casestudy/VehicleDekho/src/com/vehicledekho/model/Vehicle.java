...
public class Vehicle {
	...
	if (Double.doubleToLongBits(price) != Double.doubleToLongBits(other.price))
	    return false;
	if (Double.doubleToLongBits(roadTax) != Double.doubleToLongBits(other.roadTax))
	    return false;
	return true;
    }
	...
	return "Vehicle [make=" + make + ", model=" + model + ", engineInCC=" + engineInCc + ", fuelCapacity=" + fuelCapacity + ", mileage="
