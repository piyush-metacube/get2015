...
<body>
	<header> <span class="brand"><a href="index.jsp">Howdy,
			Visitor</a></span> <a href="#" onClick="showLogin()">Login</a> <a href="#"
		onClick="showSignup()">Sign Up</a> </header>
	...
	<div class="form" id="loginForm">
		<table>
			<form action="FormHandler" method="post"
				...
				<tr>
					<td>Enter UserId:</td>
					<td><input type="text" id="loginUser" name="user"
				...
				<tr>
					<td colspan="2" align="center" id="loginError">
						<%
	...
	<div class="form" id="signUpForm">
		<table>
			<form action="./FormHandler" method="post"
				...
				<tr>
					<td></td>
					<td align="center"><label id="nameError"> <%
 ...
 %>
				...
				<tr>
					...
					<td><input type="number" name="pNumber" id="pNumber"
						placeholder="Primary Phone Number"></td>
				</tr>
				<tr>
					<td></td>
